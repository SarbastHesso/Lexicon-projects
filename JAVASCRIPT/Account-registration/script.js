...
const inputContentValidation = () => {
    if (name.value === ''){
        invalidInput(name, 'All fields are required');
        return false
    } else if (username.value === ''){
        invalidInput(username, "All fields are required");
        return false
    } else {
        return true
    }
...
const emailValidation = () => {
  ...
  if (email.value === "") {
    invalidInput(email, "All fields are required");
    return false;
...
const passwordValidation = () => {
    ...
    if (password.value === '') {
      invalidInput(password, "All fields are required");
      return false;
...
const ConfirmPasswordValidation = () => {
    if (confirmPassword.value === '') {
      invalidInput(confirmPassword, "All fields are required");
      return false;
    } else if (confirmPassword.value !== password.value) {
      invalidInput(confirmPassword, "The passwords don't match");
      return false;
    } else {
      return true;
    }
