...
function renderPlaylist() {
  ...
  playlist.forEach(song => {
    ...
    <li class="playlist-item" id=${song.id}>
        ...
        <div class="playlist-item-btn-container">
            <span class="playlist-item-btn material-icons play-btn">play_circle</span>
        </div>
    </li>
    `;
...
playlistView.addEventListener("click", (e) => {
  ...
  for (let i = 0; i < playlist.length; i++) {
    if (
      e.target.classList[0] === "playlist-item-btn" &&
      e.target.parentElement.parentElement.id === playlist[i].id
    ) {
